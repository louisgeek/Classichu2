package com.classichu.classichu2.widget.pinned_section_sticky;
...
public class StickyItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static final int SECTION_HEADER_VIEW = 0x00000444;//值等于 BaseSectionQuickAdapter.SECTION_HEADER_VIEW 的值
