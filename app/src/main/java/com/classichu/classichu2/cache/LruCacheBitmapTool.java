...
import com.classichu.classichu2.tool.MD5Tool;
import com.classichu.classichu2.tool.SdcardTool;
...
public class LruCacheBitmapTool {
    ...
    public static void saveCacheToMemory(String keyRaw, Bitmap bitmap){
        if (bitmap==null){
            CLog.e("saveCacheToMemory bitmap is null");
            return;
        }
    ...
    public static void saveCacheToDisk(String keyRaw, Bitmap bitmap){
        if (bitmap==null){
            CLog.e("saveCacheToDisk bitmap is null");
            return;
        }
    ...
    public static void getBitmapFromUrlAndSaveCacheToDisk(final String urlStr, final OnLoadImageCallBack onLoadImageCallBack){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    CLog.d("getBitmapFromUrlAndSaveCacheToDisk:mDiskLruCache.isClosed()"+mDiskLruCache.isClosed());
